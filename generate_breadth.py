...
UNIVERSE_SYMBOLS = [
    ...
    "ACC.NS", "DALMIACEM.NS", "JKCEMENT.NS", "RAMCOCEM.NS", "SHREECEM.NS", "KAJARIACER.NS", 
    "ORIENTBELL.NS", "ASIANPAINT.NS", "BERGERPAINTS.NS", "TATASTEEL.NS", "JSWSTEEL.NS", "SAIL.NS", 
    ...
    "MARUTI.NS", "TATAMOTORS.NS", "M&M.NS", "BAJAJ-AUTO.NS", "HEROMOTOCO.NS", "TVSMOTORS.NS", 
    ...
    "WESTLIFE.NS", "SAPPHIRE.NS", "ZOMATO.NS", "NYKAA.NS", "DMART.NS", "IRCTC.NS", "EASEMYTRIP.NS", 
    ...
    "INFY.NS", "WIPRO.NS", "HCLTECH.NS", "TECHM.NS", "LTIM.NS", "MPHASIS.NS", "PERSISTENT.NS", "COFORGE.NS",
    "FIRSTSOURCE.NS", "MASTEK.NS", "RATEGAIN.NS", "KPITTECH.NS", "INDIGO.NS", "SPICEJET.NS", "BLUEDART.NS", 
...
YAHOO_MAP = {
    "BERGERPAINTS.NS": "BERGEPAINT.NS", "VARDHMAN.NS": "VTL.NS", "FIRSTSOURCE.NS": "FSL.NS",
    "GUJARATGAS.NS": "GUJGASLTD.NS", "KALYAN.NS": "KALYANKJIL.NS", "TVSMOTORS.NS": "TVSMOTOR.NS",
    "FINOLEX.NS": "FINCABLES.NS", "GMRINFRA.NS": "GMRAIRPORT.NS", "DALMIACEM.NS": "DALBHARAT.NS",
...
TARGET_SECTORS = {
    ...
    "Information Technology": {"target_count": 54, "symbols": ["TCS.NS", "INFY.NS", "WIPRO.NS", "HCLTECH.NS", "TECHM.NS", "LTIM.NS", "MPHASIS.NS", "PERSISTENT.NS", "COFORGE.NS", "FIRSTSOURCE.NS", "MASTEK.NS", "RATEGAIN.NS", "KPITTECH.NS"]},
    "Consumer Discretionary": {"target_count": 68, "symbols": ["VOLTAS.NS", "BLUESTARCO.NS", "WHIRLPOOL.NS", "HAVELLS.NS", "CROMPTON.NS", "VGUARD.NS", "TITAN.NS", "KALYAN.NS", "SENCO.NS", "PCJEWELLER.NS", "KANSAINER.NS", "AKZOINDIA.NS", "PAGEIND.NS", "TRENT.NS", "RAYMOND.NS", "MANYAVAR.NS", "ARVIND.NS", "TRIDENT.NS", "KPR.NS", "VARDHMAN.NS", "WELSPUNIND.NS", "INDHOTEL.NS", "LEMONTREE.NS", "CHALET.NS", "MAHINDRAHOLIDAYS.NS", "JUBLFOOD.NS", "DEVYANI.NS", "WESTLIFE.NS", "SAPPHIRE.NS", "ZOMATO.NS", "NYKAA.NS", "DMART.NS", "IRCTC.NS", "EASEMYTRIP.NS", "THOMASCOOK.NS"]},
    ...
    "Industrials & Capital Goods": {"target_count": 62, "symbols": ["HAL.NS", "BDL.NS", "BEML.NS", "COCHINSHIP.NS", "MAZDOCK.NS", "PARAS.NS", "ABB.NS", "SIEMENS.NS", "BHEL.NS", "CUMMINSIND.NS", "THERMAX.NS", "AIAENG.NS", "LT.NS", "NCC.NS", "KNRCON.NS", "PNCINFRA.NS", "GRINFRA.NS", "POLYCAB.NS", "APLAPOLLO.NS", "SUPREMEIND.NS", "ASTRAL.NS", "FINOLEX.NS", "INDIGO.NS", "SPICEJET.NS", "BLUEDART.NS", "DELHIVERY.NS", "MAHLOG.NS", "GESHIP.NS", "ADANIPORTS.NS", "CONCOR.NS", "ULTRACEMCO.NS", "GRASIM.NS", "AMBUJACEM.NS", "ACC.NS", "DALMIACEM.NS", "JKCEMENT.NS", "RAMCOCEM.NS", "SHREECEM.NS", "KAJARIACER.NS", "ORIENTBELL.NS", "ASIANPAINT.NS", "BERGERPAINTS.NS", "TNPL.NS", "JKPAPER.NS", "CENTURYPLY.NS", "GREENPLY.NS", "GMRINFRA.NS"]},
    ...
    "Automobiles": {"target_count": 35, "symbols": ["MARUTI.NS", "TATAMOTORS.NS", "M&M.NS", "BAJAJ-AUTO.NS", "HEROMOTOCO.NS", "TVSMOTORS.NS", "EICHERMOT.NS", "ASHOKLEY.NS", "ESCORTS.NS", "FORCEMOT.NS", "MOTHERSON.NS", "BOSCHLTD.NS", "BHARATFORG.NS", "APOLLOTYRE.NS", "MRF.NS", "BALKRISIND.NS", "EXIDEIND.NS", "SUNDRMFAST.NS"]},
